...
class AuthorizerAccessController extends Controller
{
    public function getComponentLoginPage(){
        ...
        $url="https://mp.weixin.qq.com/cgi-bin/componentloginpage?component_appid=$wx->appId&pre_auth_code=$pre_auth_code&redirect_uri=http://auth.event.wx.yilu.co&auth_type=3";
